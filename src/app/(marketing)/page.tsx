...
const ValueLadder = dynamic(
    ...
    { loading: () => <div className="animate-pulse h-96 bg-white/50 rounded-3xl" /> }
);

const Services = dynamic(
    () => import('@/features/marketing/components/Services').then((mod) => mod.Services),
    { loading: () => <div className="animate-pulse h-80 bg-white/50 rounded-3xl" /> }
);

const SocialProof = dynamic(
    () => import('@/features/marketing/components/SocialProof').then((mod) => mod.SocialProof),
    { loading: () => <div className="animate-pulse h-72 bg-white/50 rounded-3xl" /> }
);

const BookingEngine = dynamic(
    () => import('@/features/booking/components/BookingEngine').then((mod) => mod.BookingEngine),
    { loading: () => <div className="animate-pulse h-64 bg-white/50 rounded-3xl" /> }
);

const FAQ = dynamic(
    () => import('@/features/marketing/components/FAQ').then((mod) => mod.FAQ),
    { loading: () => <div className="animate-pulse h-60 bg-white/50 rounded-3xl" /> }
);
